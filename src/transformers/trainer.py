...
class Trainer:
    ...
    def __init__(
        ...
        eval_dataset_mnli_mm: Optional[Dataset] = None,
    ):
        if args is None:
        ...
        self.eval_dataset_mnli_mm = eval_dataset_mnli_mm
    ...
    def train(
        ...
        **kwargs,
        ...
        # if we want to load a MoE model, first expand the model, then load the weights;
